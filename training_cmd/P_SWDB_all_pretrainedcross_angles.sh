...
python $SCRIPTPATH \
--model_name 'pretrainedcross-freeze20' --set_type 'SWDB_angles' --n_epochs 1000 --batch_size 8 \
--num_workers 1 --optimizer 'sgd' --lr 0.0001  --weight_decay 0.0001 \
--pretrained_path 'log_CeNDR/angles_20180531_125503_R_simpledilated_sgd_lr0.0001_wd0_batch8' \
