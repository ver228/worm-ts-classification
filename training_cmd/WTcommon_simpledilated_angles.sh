...
python $SCRIPTPATH --model_name 'simpledilated' --set_type 'angles' --n_epochs 1000 --batch_size 8 --num_workers 1 \
--is_common_WT --lr 0.0001 --copy_tmp '/tmp/avelino'$CUDA_VISIBLE_DEVICES
