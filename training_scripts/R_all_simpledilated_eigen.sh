...
python $SCRIPTPATH \
--model_name 'simpledilated' --set_type 'eigen' --n_epochs 1000 --batch_size 8 \
--num_workers 1 --optimizer 'sgd' --lr 0.0001  --weight_decay 0.0001 \
--copy_tmp '/tmp/avelino'$CUDA_VISIBLE_DEVICES \
--init_model_path 'logs/eigen_20180627_204806_simpledilated_sgd_lr0.001_wd0.0001_batch8/model_best.pth.tar'
